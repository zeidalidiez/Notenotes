...
- [x] **Lyric sharing** - shared MIDI snippets keep note-attached lyrics, with long note text trimmed in the link payload so one pasted wall of words does not break the URL.
