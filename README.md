...
- **Mobile and desktop focus, including iOS Safari** - touch drag-and-drop everywhere, a cleaner labeled transport menu on narrow screens, a tap-friendly BPM editor, a collapsible snippets tray, and extra audio unlock nudges when a real note or drum hit happens.
